...
BAT_PATH             = r"C:\RPA_CNS\RPACNs\Init.bat"
...
def send_msg(error):
    try:
        ...
        telegram_api=f"https://api.telegram.org/bot8426416631:AAEDYPkcuN3sRoyOAbFIYFeWhxt6gINTvrE/sendMessage?chat_id=-1002094293899&text={msg}"
